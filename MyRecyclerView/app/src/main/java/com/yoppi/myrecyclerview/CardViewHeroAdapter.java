...
public class CardViewHeroAdapter extends RecyclerView.Adapter<CardViewHeroAdapter.CardViewViewHolder> {
    ...
    @NonNull
    @Override
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewTyipe) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_carview_hero, viewGroup, false);
